var serviceProviders = [
    {
      ...
      details:
        "Service Provider Details... experience, no. of customers served, expertise...",
      rating: 5,
      minCharge: 199,
      maxCharge: 499,
    },
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    let tempString = sessionStorage.getItem('nameString');

    subHeading.textContent = tempString;

    let providerCards = document.querySelectorAll(".provider-card");

    providerCards.forEach(element => {
      element.addEventListener("click", () => {
        window.location.href = "/4You/serviceProvider.html";
      });
    });
